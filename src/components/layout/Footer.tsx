    ...
    <footer className="bg-foreground text-background py-12">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-background/70 text-sm">
              Khám phá ẩm thực Việt Nam với hàng nghìn địa điểm được đánh giá và
              đề xuất bởi AI.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-background/70">
              ...
              <li>
                <Link
                  to="/explore?category=streetfood"
                  className="hover:text-background transition-colors"
                >
                  Ẩm thực đường phố
                </Link>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-background/70">
              <li className="flex items-center gap-2">
                ...
                <span>support@gohangout.vn</span>
              </li>
              <li className="flex items-center gap-2">
        ...
        <div className="border-t border-background/10 mt-8 pt-8 text-center text-sm text-background/50">
          <p>© 2025 GoHangOut. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
